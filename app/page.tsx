      ...
      <section className="px-4 py-12 sm:px-6 lg:px-8" aria-labelledby="search-intent-paths">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
            <Link prefetch={false} href="/where/canada" className="rounded-lg border border-white/10 bg-white/[0.04] p-5 transition hover:border-emerald-300/50 hover:bg-white/[0.07]">
            ...
            <Link prefetch={false} href="/where/florida" className="rounded-lg border border-white/10 bg-white/[0.04] p-5 transition hover:border-emerald-300/50 hover:bg-white/[0.07]">
            ...
            <Link prefetch={false} href="/where/washington" className="rounded-lg border border-white/10 bg-white/[0.04] p-5 transition hover:border-emerald-300/50 hover:bg-white/[0.07]">
            ...
            <Link prefetch={false} href="/hantavirus-risk-map" className="rounded-lg border border-white/10 bg-white/[0.04] p-5 transition hover:border-emerald-300/50 hover:bg-white/[0.07]">
            ...
            <Link prefetch={false} href="/hantavirus-tracker" className="rounded-lg border border-white/10 bg-white/[0.04] p-5 transition hover:border-emerald-300/50 hover:bg-white/[0.07]">
          ...
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            {alerts.slice(0, 3).map((alert) => (
              <article key={alert.id} className="rounded-lg border border-white/10 bg-white/[0.04] p-5">
                ...
                <Link prefetch={false} href={`/event/${alert.id}`} className="mt-5 inline-flex rounded-md border border-emerald-300/35 px-4 py-3 text-sm font-semibold text-emerald-100 transition hover:border-emerald-200 hover:text-white">
                  Read reviewed event
                </Link>
              </article>
            ))}
